    ...
    return (
        <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                ...
                <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore officiis tempore inventore deserunt ut cumque fuga, eos quos itaque in ab. Placeat, modi nihil.</p>
                <div className='my-11 flex flex-wrap gap-5'>
                    <div className="flex items-center gap-2">{Array(5).fill(1).map((_, i) => (
